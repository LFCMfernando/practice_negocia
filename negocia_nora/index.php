...
"></i>
  ...
  <button type="button" onclick="$('#fcclientes-modal').modal('show'); fcRegistro_obtener_data_ws(0,6,1,2);$('#fcRegistroTitulo').html('crear Proveedor');"
    style="float: right; margin-top: 50px; margin-right: 10px;">crear_proveedor</button>

    <button type="button" onclick="$('#fcclientes-modal').modal('show'); fcRegistro_obtener_data_ws(139003,6,2,2);$('#fcRegistroTitulo').html('Editar Proveedor');"
    style="float: right; margin-top: 50px; margin-right: 10px;">Editar_proveedor</button>
...
<div class="dropdown" style="float: right; margin-top: 50px; margin-right: 10px;">
  ...
  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton2" style="min-width: 160px;">
    <li>
      <a class="dropdown-item d-flex align-items-center" 
         ...
         onclick="fcRegistro_abrirModalPersona();$('#fcRegistroTitulo').html('crear cliente');">
         <!-- Ícono de usuario -->
  ...
  <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6m2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0m4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4m-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10s-3.516.68-4.168 1.332c-.678.678-.83 1.418-.832 1.664z"/>
    ...
    <li>
      <a class="dropdown-item d-flex align-items-center" 
         href="javascript:void(0);" 
         onclick="fcRegistro_abrirModalEmpresa();$('#fcRegistroTitulo').html('crear cliente');">
         <!-- Ícono de edificio -->
...
<button type="button" onclick="$('#fcclientes-modal').modal('show'); fcRegistro_obtener_data_ws(139003,0,2,1);"
